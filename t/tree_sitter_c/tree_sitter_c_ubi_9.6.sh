...
# Version          : v0.23.2
# Source repo      : https://github.com/tree-sitter/tree-sitter-c
# Tested on     : UBI:9.6
# Language      : Python
# Ci-Check  : True
...
# Variables
PACKAGE_NAME=tree_sitter_c
PACKAGE_VERSION=${1:-v0.23.2}
PACKAGE_URL=https://github.com/tree-sitter/tree-sitter-c
PACKAGE_DIR=tree_sitter_c
...
if [ -f "./test" ] && [ $test_status -ne 0 ]; then
    echo "Running test..."
    tree-sitter generate && tree-sitter test && test_status=0 || test_status=$?
fi
